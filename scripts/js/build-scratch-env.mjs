 ...
 * @summary       Orchestrates scratch org setup for this demo branch.
 * @description   Composes shared tasks from setup-tasks.mjs into the sequence needed
 *                to create and configure a scratch org for this demo.
...
import { agentUsername, agentNickname, baselineTag,
         ...
         devOrgAlias, devOrgConfigFile }  from './setup.mjs';
 ...
 * @summary     Builds a scratch org-based development environment for this demo.
...
export async function buildScratchEnv() {
  ...
  deleteScratchOrg(tr, devOrgAlias);
  //*/
  //───────────────────────────────────────────────────────────────────────────────────────────────┘
  //───────────────────────────────────────────────────────────────────────────────────────────────┐
  //*
  // Create a new DEVELOPMENT scratch org.
  createScratchOrg(tr, devOrgAlias, devOrgConfigFile);
  //*/
  //───────────────────────────────────────────────────────────────────────────────────────────────┘
  //───────────────────────────────────────────────────────────────────────────────────────────────┐
  //*
  ...
  publishAgent(tr, 'Local_Info_Agent', { skipRetrieve: true });
  //*/
  //───────────────────────────────────────────────────────────────────────────────────────────────┘
  //───────────────────────────────────────────────────────────────────────────────────────────────┐
  //*
